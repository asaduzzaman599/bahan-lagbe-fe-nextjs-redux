        ...
        <div>
            <div className='w-4/5 mx-auto p-6 bg-white'>
                <Form submitHandler={onSumbit} defaultValues={defaultValues} >
                    <div className='mb-2'>
                        <FormInput name='name' type='text' placeholder='User name'/>
                    </div>
                    <div  className='mb-2'>
                        <FormInput name='email' type='email' placeholder='Email' disabled={true}/>
                    </div>
                    <div  className='mb-2'>
                        <FormInput name='contactNo' type='text' placeholder='Contact No' />
                    </div>
                    <div  className='mb-2'>
